#!/usr/bin/perl
# saved at /usr/loca/ddns/ddns.pl
# ieServer.Net 専用 DDNS IP アドレス更新スクリプト - ddns-update.pl
# 作戬恭弘@Agora Inc.　作成日:2004/03/24
#
...
# 1. 設定IPアドレスワークファイル
$CURRENT_IP_FILE = "/home/pi/current_ip";

#  2. 設定状況ログファイル
$LOG_FILE        = "/home/pi/ip_update.log";
...
$ACCOUNT         = "yourdomain";     # アカウント(サブドメイン)名設定
$DOMAIN          = "exmaple.com";     # ドメイン名設定
